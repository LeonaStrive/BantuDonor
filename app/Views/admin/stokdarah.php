                                ...
                                <div class="modal-body">
                                    <form>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" aria-label="Default select example">
                                                <option selected>Pilih Nama Rumah Sakit</option>
                                                <option value="RSU Mitra Sehat">RSU Mitra Sehat</option>
                                                <option value="RS PKU Muhammadiyah Gamping">RS PKU Muhammadiyah Gamping</option>
                                            </select>
                                        </div>
                                    </form>
                                </div>
        ...
        <table class="table table-hover text-center">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <!-- Button Detail RS -->
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalDetail">Lihat Daftar Rumah Sakit</button>
    
                        <!-- Modal Edit RS -->
                        <div class="modal fade text-left" id="modalDetail" tabindex="-1" aria-labelledby="modalDetailLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="modalDetailLabel">Golongan Darah O</h1>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <table class="table table-stripped table-detailStok">
                                            <thead>
                                                <tr>
                                                    <th>No</th>
                                                    <th>Nama Rumah Sakit</th>
