...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="dashboardrs" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Nama RS</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="dashboardrs" class="nav-link">
          ...
          <li class="nav-item">
            <a href="pendonor" class="nav-link">
